                        ...
                        <div class="header__main">
                            <div class="header__logo logo">
                                <a href="<?php echo get_home_url(); ?>" class="logo__wrap">
                                    <img src="<?php echo get_template_directory_uri() ?>/images/icon/color-logo.svg" alt="logo">
                                </a>
                            </div>
                            <div class="header__menu menu scrollto">
                                ...
                                ?>
								<div class="menu-item contact-menu-item"><a href="https://miaterra.krockds.com/#form">Contact</a></div>
