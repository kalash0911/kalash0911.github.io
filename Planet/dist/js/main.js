...
function initLanguageSelect() {
  ...
  selectedLanguageBtn.addEventListener("click", function () {
  ...
  document.addEventListener("click", function (event) {
    ...
    if (event.target.classList.contains("language-button")) {
      var newLang = event.target.dataset.lang;
...
function changeLanguageOnWebsite() {
  ...
  localizationTags.forEach(function (el) {
    el.textContent = "".concat(_i18next.default.t(el.dataset.localization));
  });
