...
module.exports={
    ...
    "mainPageMissionTitle": "{{mainPageMissionTitleText}}",
    "mainPageMissionTitle1": "Усиление владельцев,",
    "mainPageMissionTitle2": "руководителей <br> и их окружения посредством увеличения обьема жизненной силы",
...
function changeLanguageOnWebsite() {
  ...
  localizationTags.forEach(function (el) {
    el.innerHTML = "".concat(_i18next.default.t(el.dataset.localization, {
      mainPageMissionTitleText: "<i class=\"tex\"><img class=\"text-line\" src=\"./images/text-line.svg\" alt=\"img-line\">".concat(_i18next.default.t("mainPageMissionTitle1"), "</i> ").concat(_i18next.default.t("mainPageMissionTitle2")),
      interpolation: {
        escapeValue: false
      }
    }));
