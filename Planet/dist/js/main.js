...
module.exports={
    ...
    "mainPageMissionTitle2": "Усиление владельцев,",
    "mainPageMissionTitle1": "руководителей <br> и их окружения посредством увеличения обьема жизненной силы"
}
...
function changeLanguageOnWebsite() {
  ...
  localizationTags.forEach(function (el) {
    el.innerHTML = "".concat(_i18next.default.t(el.dataset.localization, {
      imgTag: "<i class=\"tex\"><img class=\"text-line\" src=\"./images/text-line.svg\" alt=\"img-line\">".concat(_i18next.default.t("aboutUsText"), "</i>"),
      interpolation: {
        escapeValue: false
      }
    }));
